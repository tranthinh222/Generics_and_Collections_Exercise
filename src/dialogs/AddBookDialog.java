...
public class AddBookDialog extends JDialog {
    ...
    public void clearFields() {
        ...
        this.publicationYearField.setText("");
    ...
    private String validateInput() {
        if (this.isbnField.getText().trim().isEmpty()) {
        ...
        if (bm.isbnExists(this.isbnField.getText().trim())) {
            return "ISBN này đã tồn tại trong hệ thống!";
        }
