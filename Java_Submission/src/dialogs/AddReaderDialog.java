...
public class AddReaderDialog extends JDialog {
    ...
    public AddReaderDialog(JFrame parent) {
        super(parent, "Add New Reader", true);
    ...
    private JPanel createFieldRow(String labelText, Font labelFont, Font inputFont, JTextField field) {
        ...
        javax.swing.text.PlainDocument doc = new PlainDocument();
    ...
    private Filler createVerticalSpace() {
        return new Filler(
                new Dimension(0, 5), new Dimension(0, 5), new Dimension(0, 5));
    }
    ...
    public Reader getReader() {
        ...
        LocalDate cardCreationDate = LocalDate.now();
